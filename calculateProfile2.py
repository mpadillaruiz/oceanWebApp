...
#polygon= "LINESTRING(-66.16069793701173 45.30024859349336,-66.15443229675294 45.301697517065165,-66.14971160888673 45.29813551357697)";
...
print("<p>Total length of the profile: "+str(ddlist[len(ddlist)-1])+"</p>")
